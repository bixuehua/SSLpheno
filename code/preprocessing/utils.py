...
from ontology import get_ns_id, get_root, get_subontology
...
def load_annotation(raw_annotation, ontology,
                    split=True, keep_root=False, propagate=None):
    ...
    leaf_annotation = raw_annotation
